<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistrarAlumnos.aspx.cs" Inherits="UI.Web.RegistrarAlumnos" %>
...
<asp:Content ID="RegistrarAlumno" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <asp:Panel ID="formPanel" Visible="false" HorizontalAlign="Center" runat="server" Height="159px">
        ...
        <asp:DropDownList ID="idCursoddl" runat="server" DataValueField="ID" DataTextField="ID"></asp:DropDownList>
        <br />
